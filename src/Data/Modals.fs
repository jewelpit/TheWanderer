...
let private showModal title content text dispatch =
    R.a [Nowhere; P.OnClick (fun _ -> dispatch <| ShowModal (title, content))] [
        R.str text
    ]
...
let Etzeznalt = etzeznalt "Etzeznalt"
